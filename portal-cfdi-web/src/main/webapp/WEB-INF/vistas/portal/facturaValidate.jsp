...
<body>
	<div class="container main-content">
		<div class="white-panel row">
			...
			<form:form action="${urlDocumento}" id="formPdf" modelAttribute="documento" method="post">
				<div class="row">
					<div class="col-md-4">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-8 col-md-8">
										<input id="noSucursal" class="form-control input-sm" value="${documento.ticket.transaccion.transaccionHeader.idSucursal}" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label for="noTicket" class="col-lg-4 col-md-4 control-label"><small>No. de Ticket: </small></label>
									<div class="col-lg-8 col-md-8">
										<input id="noTicket" class="form-control input-sm" value="${documento.ticket.transaccion.transaccionHeader.idTicket}" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label for="noCaja" class="col-lg-4 col-md-4 control-label"><small>No. de Caja: </small></label>
									<div class="col-lg-8 col-md-8">
										<input id="noCaja" class="form-control input-sm" value="${documento.ticket.transaccion.transaccionHeader.idCaja}" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label for="fechahora" class="col-lg-4 col-md-4 control-label"><small>Fecha y Hora: </small></label>
									<div class="col-lg-8 col-md-8">
										<input id="fechahora" class="form-control input-sm" value="${documento.ticket.transaccion.transaccionHeader.fechaHora}" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
						...
						<div class="white-panel form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-2 col-md-2">
	 									<input id="total" class="form-control input-sm has-error" value="<fmt:formatNumber value="${documento.comprobante.total}" type="currency"/>" readonly="readonly"/>
									</div>
								</div>
							</fieldset>
						</div>
