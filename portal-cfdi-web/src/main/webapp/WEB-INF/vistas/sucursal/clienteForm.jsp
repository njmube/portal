			...
			<div class="well col-md-10 col-md-offset-1">
				...
				<form:form id="receptorForm" action="${altaUrl}" method="POST" modelAttribute="receptor" cssClass="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<form:input path="domicilio.calle" id="calle" cssClass="form-control"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-2">No. Interior: </label>
						<div class="col-lg-2">
							<form:input path="domicilio.noInterior" id="noInterior" cssClass="form-control"/>
						</div>
						<label class="control-label col-lg-4">No. Exterior: </label>
						<div class="col-lg-2">
							<form:input path="domicilio.noExterior" id="noExterior" cssClass="form-control"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-2">Colonia: </label>
						<div class="col-lg-4">
							<form:input path="domicilio.colonia" id="colonia" cssClass="form-control"/>
						</div>
						<label class="control-label col-lg-2">Localidad: </label>
						<div class="col-lg-4">
							<form:input path="domicilio.localidad" id="localidad" cssClass="form-control"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-2">Referencia: </label>
						<div class="col-lg-10">
							<form:input path="domicilio.referencia" id="referencia" cssClass="form-control"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-2">Municipio: </label>
						<div class="col-lg-4">
							<form:input path="domicilio.municipio" id="municipio" cssClass="form-control"/>
						</div>
						<label class="control-label col-lg-2">Estado: </label>
						<div class="col-lg-4">
							<form:input path="domicilio.estado" id="estado" cssClass="form-control"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-2">País: </label>
						<div class="col-lg-4">
							<form:select path="domicilio.pais" id="pais" cssClass="form-control">
								<form:option value="México">México</form:option>
							</form:select>
						</div>
						<label class="control-label col-lg-2">Código Postal: </label>
						<div class="col-lg-4">
							<form:input path="domicilio.codigoPostal" id="codigoPostal" cssClass="form-control"/>
						</div>
					</div>
					<hr>
					<div class="form-group">
