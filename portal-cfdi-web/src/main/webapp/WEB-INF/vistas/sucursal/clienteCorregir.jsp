								...
								<c:choose>
									<c:when test="${not empty clienteCorregir.domicilios}">
										<c:forEach items="${clienteCorregir.domicilios}" var="domicilio" varStatus="theCount">
											<tr>
												<td width="200px"><form:input path="domicilios[${theCount.index}].calle" id="calle${theCount.index}" cssClass="form-control input-xsm validate[required]"/></td>
												<td width="65px"><form:input path="domicilios[${theCount.index}].noExterior" id="noExterior${theCount.index}" cssClass="form-control input-xsm validate[required, integer, minSize[1]]"/></td>
												<td width="65px"><form:input path="domicilios[${theCount.index}].noInterior" id="noInteriorr${theCount.index}" cssClass="form-control input-xsm validate[integer]"/></td>
												<td width="100px">
													<form:hidden path="domicilios[${theCount.index}].estado.pais.id" id="paisOculto"/>
												  	<select class="form-control-xsm validate[required] pais" id="pais">
												...
												<td width="100px">
													...
													<select class="form-control-xsm validate[required] estado" id="estado" >
												  		<option value="">- Seleccione una opción -</option>
												...
												<td><form:input path="domicilios[${theCount.index}].municipio" id="municipio${theCount.index}" cssClass="form-control input-xsm validate[required]"/></td>
												<td width="200px"><form:input  path="domicilios[${theCount.index}].colonia" id="colonia${theCount.index}" cssClass="form-control input-xsm validate[required]"/></td>
