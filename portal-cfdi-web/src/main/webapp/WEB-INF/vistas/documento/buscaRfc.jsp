	...
	<div class="container main-content">
		<div class="white-panel row">
			...
			<sec:authorize access="hasRole('ROLE_SUC')">
				<c:url var="urlCancelar" value="/modificarFactura"/>
			</sec:authorize>
			<div class="well col-md-offset-2 col-md-8">
				<form:form id="receptorForm" action="#" method="get" modelAttribute="cliente" cssClass="form-horizontal" role="form">
					...
					<div class="form-group">
						<div class="centered">
							<button id="crearClienteRefact" type="button" class="btn btn-warning">Nuevo Cliente <i class="fa fa-plus"></i></button>
							<button id="buscarClienteRefact" type="button" class="btn btn-primary">Buscar <i class="fa fa-search"></i></button>
