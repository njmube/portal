...
<body>
			...
			<div class="well col-md-offset-0 col-md-12">
				<div class="table-responsive">
					<display:table htmlId="domicilios" id="domicilio" name="${cliente.domicilios}"
						...
						requestURI="/refacturacion/confirmarDatos">
	...
	<%-- 								</c:choose> --%>
				...
				<p class="text-center"> 
					...
					<a href="<c:url value="/refacturacion/clienteCorregir/${cliente.id}"/>" class="btn btn-warning"><span>Modificar</span> <i class="fa fa-pencil-square-o"></i></a>
					<a href="<c:url value="/refacturacion/buscaRfc"/>" class="btn btn-danger"><span>Cancelar</span> <i class="fa fa-times"></i></a>
				</p>
		</div>				
	</div>
	<script type="text/javascript">
		$(document).ready(function () {
			...
			<sec:authorize access="hasRole('ROLE_SUC')">
				var urlContinue = contextPath + "/refacturacion/cambiarCliente/";
			</sec:authorize>
